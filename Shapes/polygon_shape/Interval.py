...
class Interval(HalfLine):
    def __init__(self, center=Point(0, 0), angle=0, size=10, out_color='black'):
        """
    ...
    def move_center(self, new_coords: Point):
        ...
        left_coord = Point(self._centre._x - self._size / 2 * math.cos(self._angle * math.pi / 180),
                           self._centre._y - self._size / 2 * math.sin(self._angle * math.pi / 180))

        right_coord = Point(self._centre._x + self._size / 2 * math.cos(self._angle * math.pi / 180),
                            self._centre._y + self._size / 2 * math.sin(self._angle * math.pi / 180))
